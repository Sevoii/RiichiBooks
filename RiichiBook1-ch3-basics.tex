...
\bigskip
\noindent
This hand becomes ready to win if you discard {\mahjong[15pt]{6p}} or {\mahjong[15pt]{7p}}. Let's compare the two choices.
\bi\itemsep.1pt
...
\ei
Which discard choice is better? Although both of the two choices yield a 2-way wait, waiting for {\mahjong[15pt]{5p} \mahjong[15pt]{8p]}} is much better than waiting for {\mahjong[15pt]{4m} \mahjong[15pt]{6p]}}, probabilistically speaking. With the {\mahjong[15pt]{5p} \mahjong[15pt]{8p]}} wait, there are four tiles of {\mahjong[15pt]{5p}} and another four tiles of {\mahjong[15pt]{8p}} to win on, leaving at most eight winning tiles.\footnote{Of course, the number of winning tiles could be smaller than eight if some of them have already been discarded.} 
With the {\mahjong[15pt]{4m} \mahjong[15pt]{6p]}} wait, on the other hand, you have already used up two tiles of {\mahjong[15pt]{4m}} and two tiles of {\mahjong[15pt]{6p}} yourself, leaving at most four winning tiles. It is clearly better to choose the {\mahjong[15pt]{5p} \mahjong[15pt]{8p]}} wait over the {\mahjong[15pt]{4m} \mahjong[15pt]{6p]}} wait, because that will give you a higher probability of winning this hand. 

\bigskip
It is possible that, after you decided on the {\mahjong[15pt]{5p} \mahjong[15pt]{8p]}} wait, your opponents end up not discarding {\mahjong[15pt]{5p}} or {\mahjong[15pt]{8p}} at all, while discarding lots of {\mahjong[15pt]{4m} \mahjong[15pt]{6p]}}. This is the kind of thing that will happen often in mahjong (or in any game of luck, for that matter). When things like this happen, do not think that you made a bad call; you didn't. You made the right choice, but you were just unlucky. When we experience this kind of bad luck, we just need to keep calm and carry on.
